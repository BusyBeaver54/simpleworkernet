# Документация SimpleWorkerNet

| Раздел | Описание |
|--------|----------|
| [Установка](installation.md) | pip, опциональные зависимости |
| [Быстрый старт](quickstart.md) | первый клиент, SmartData |
| [Конфигурация](configuration.md) | `config_manager`, defaults |
